...
//       try {
//         const data = await get_branch_tax_report(fc_code.fc_code, currentMonth);
//         setData(data);
//       } catch (error) {
...
//   };
//   const handleExport = () => {
//     const headers = ["Employee Name", "Tin NO","Basic Salary","Transport Allowance","Other Benefit","House Allowance","Taxable Income","Tax Withhold","Net Pay","Branch Code", "Branch Name","date"]
...
const TaxReport = () => {
  ...
  const handleExport = () => {
    const headers = ["Employee Name", "Tin NO", "Basic Salary", "Transport Allowance", "Other Benefit", "House Allowance", "Taxable Income", "Tax Withhold", "Net Pay", "Branch Code", "Branch Name", "date"];
    const newdata = [headers, ...data.map((item) => [
      item.fullName,
      item.tin,
      item.salary,
      item.transport,
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCell>
                <Typography align="```javascript
              left" color="textSecondary" variant="h6">
                  Employee Name
                </Typography>
              </TableCell>
              <TableCell>
            ...
            {data
              ...
              .map((emp, index) => (
                <TableRow key={emp.id}>
                  ...
                  <TableCell>
                    <Typography>
                      {branchNamesMap[emp.branch] || "Unknown Branch"}  {/* Display branch name */}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography>
