            ...
            {data
              ...
              .map((emp, index) => (
                <TableRow key={emp.id}>
                  ...
                  <TableCell>
                    <Typography variant="h6">
                      {numeral(emp.employeeContribution).format("0,0.00")}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography variant="h6">
                      {numeral(emp.employerContribution).format("0,0.00")}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography>
                      {numeral(emp.totalPension).format("0,0.00")}
                    </Typography>
                  </TableCell>
                  <TableCell>
